        ...
        protected override void Seed(Loyalty.DataAccess.AnatoliDbContext context)
        {
          //if (_pendingMigrations)
            if (true)
            {
                ...
                #region Base Data
                context.LoyaltyCardSetGenerateTypes.AddOrUpdate(item => item.Id,
                    new LoyaltyCardSetGenerateType { Id = Guid.Parse("AEBC1016-A309-440D-A9AE-DADA3D33D8D8"), LoyaltyCardSetGenerateTypeName = "شماره سریال", IsRemoved = false, ApplicationOwnerId = Guid.Parse("79A0D598-0BD2-45B1-BAAA-0A9CF9EFF240"), DataOwnerId = Guid.Parse("3EEE33CE-E2FD-4A5D-A71C-103CC5046D0C"), DataOwnerCenterId = Guid.Parse("3EEE33CE-E2FD-4A5D-A71C-103CC5046D0C"), CreatedDate = DateTime.Now, LastUpdate = DateTime.Now, },
                    new LoyaltyCardSetGenerateType { Id = Guid.Parse("E6559D55-FC64-4E2A-A82B-2CFFE940199B"), LoyaltyCardSetGenerateTypeName = "شماره تولیدی", IsRemoved = false, ApplicationOwnerId = Guid.Parse("79A0D598-0BD2-45B1-BAAA-0A9CF9EFF240"), DataOwnerId = Guid.Parse("3EEE33CE-E2FD-4A5D-A71C-103CC5046D0C"), DataOwnerCenterId = Guid.Parse("3EEE33CE-E2FD-4A5D-A71C-103CC5046D0C"), CreatedDate = DateTime.Now, LastUpdate = DateTime.Now, }
                    );
